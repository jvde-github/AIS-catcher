SRC = Application/Config.cpp Control/ControlCore.cpp Control/ControlServer.cpp Application/DeviceManager.cpp Web/BackupManager.cpp Application/Engine.cpp Web/FrontendConfig.cpp Application/CommandLine.cpp Application/Main.cpp Control/ManagedMain.cpp Web/MapTiles.cpp Web/Prometheus.cpp Application/Receiver.cpp Web/WebDB.cpp Web/WebViewer.cpp Web/ViewerConfiguration.cpp Web/ViewerSettings.cpp DBMS/PostgreSQL.cpp DBMS/DatabaseOutput.cpp DBMS/CSV.cpp DBMS/SQLite.cpp Device/AIRSPY.cpp Device/AIRSPYHF.cpp Device/FileRAW.cpp Device/FileWAV.cpp Device/HACKRF.cpp Device/HYDRASDR.cpp Device/N2KsktCAN.cpp Device/RTLSDR.cpp Device/RTLTCP.cpp Device/SDRPLAY.cpp Device/Serial.cpp Device/SoapySDR.cpp Device/SpyServer.cpp Device/UDP.cpp Device/ZMQ.cpp DSP/Decoder/V2/V2Engine.cpp DSP/Demod.cpp DSP/DSP.cpp DSP/Model.cpp IO/HTTPClient.cpp IO/HTTPServer.cpp IO/MsgOut.cpp IO/Screen.cpp IO/N2KInterface.cpp IO/N2KStream.cpp IO/Network.cpp IO/Protocol.cpp JSON/JSON.cpp JSON/JSONAIS.cpp JSON/Keys.cpp JSON/Parser.cpp Aviation/ADSB.cpp Aviation/Basestation.cpp Aviation/Beast.cpp Marine/AIS.cpp Marine/Message.cpp Marine/N2K.cpp Marine/NMEA.cpp Library/Logger.cpp IO/TCPServer.cpp Tracking/DB.cpp Tracking/PlaceCatalogue.cpp Tracking/ReceiverTracker.cpp Tracking/Ships.cpp Tracking/Region.cpp Tracking/RegionTree.cpp Utilities/Parse.cpp Utilities/Convert.cpp Utilities/Helper.cpp Utilities/TemplateString.cpp Utilities/StreamHelpers.cpp
OBJ = $(addprefix obj/,$(SRC:.cpp=.o))
INCLUDE = -I. -ISource -ISource/JSON/ -ISource/DBMS/ -ISource/Tracking/ -ISource/Library/ -ISource/Marine/ -ISource/Aviation/ -ISource/DSP/ -ISource/Application/ -ISource/Web/ -ISource/Control/ -ISource/IO/ -ISource/Utilities/ 
CC = clang
