...
OBJ = Main.o IO.o DSP.o AIS.o Model.o Utilities.o Network.o Demod.o RTLSDR.o AIRSPYHF.o AIRSPY.o FileRAW.o FileWAV.o SDRPLAY.o RTLTCP.o HACKRF.o ZMQ.o SoapySDR.o TCP.o SpyServer.o JSON.o JSONAIS.o
