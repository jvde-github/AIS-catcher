...
- GPS input is included in screen output as NMEA or JSON depending on the output switch (`-o x`). GPS output can be filtered out using `FILTER ON GPS OFF` directly after the `-o x` switch where x is the output mode. To be done: more testing and multi-plexing GPS output to UDP and TCP connections.
...
In a similar fashion `-c X` will decode one channel at mid frequency which is only useful for input over file. See ZMQ example below.
...
|v0.52| [ZIP](https://github.com/jvde-github/AIS-catcher/releases/download/v0.52/AIS-catcher.x86.zip) | [ZIP](https://github.com/jvde-github/AIS-catcher/releases/download/v0.52/AIS-catcher.x64.zip) | [ZIP](https://github.com/jvde-github/AIS-catcher/releases/download/v0.52/AIS-catcher.SDRPLAY.x86.zip) | [ZIP](https://github.com/jvde-github/AIS-catcher/releases/download/v0.51b/AIS-catcher.SDRPLAY.x64.zip) |
