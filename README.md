...
The program provides the option to read and decode the raw discriminator output of a VHF receiver as well. AIS-catcher also supports the ShipXplorer(R) AIS dongle.
