...
A proper credit section needs to be added but the web-interface gratefully uses the following libraries: chart.js, chart.js annotation plugin, leaflet, awesomefonts and flag-icons.
