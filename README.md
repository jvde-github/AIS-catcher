...
```
This same information but wrapped in JSON can be generated with the switch ```-o 3``` to facilitate further processing downstream:
```
...
```
Full decoding of the AIS message is activated via ``-o 4``:
```
