...
const tagName2Code = globals_js_1.tags;
...
const typeName2byte = globals_js_1.fieldTypes;
// config variables
...
const _writeIFD = (bin, data, _offset, ifd) => {
    ...
    for (const key of keys) {
        const typeName = /** @type {keyof typeName2byte} */ (globals_js_1.fieldTagTypes[key]);
...
function writeGeotiff(data, metadata) {
    ...
    if (!finalMetadata.SampleFormat) {
        ...
        finalMetadata.SampleFormat = (0, utils_js_1.times)(numBands, () => sampleFormat);
    }
    ...
    if (!finalMetadata.GeoKeyDirectory) {
        ...
        geoKeys.forEach((geoKey) => {
            ...
            const tagType = globals_js_1.fieldTagTypes[KeyID];
