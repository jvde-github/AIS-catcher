...
window.AISSettings = (function () {
    "use strict";

    function create(opts) {
        if (!opts || !opts.key) throw new Error("AISSettings.create needs a key");
        ...
        for (var d in defaults) if (Object.prototype.hasOwnProperty.call(defaults, d)) values[d] = defaults[d];
