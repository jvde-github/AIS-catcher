...
export function create(host) {
    ...
    function styleOf(feature) {
        ...
        if (isBadge) {
            ...
            cached = [new Style({ image: iconOf(stationCanvas(false, feature.binary_status)), zIndex: 100 })];
        } else if (label) {
            const icon = iconOf(pillCanvas(label, colorOf(cat)));
