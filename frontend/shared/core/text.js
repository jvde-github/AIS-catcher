// Pure text for AIS values: names of statuses, types, message groups, times
// and counts. Nothing here depends on host settings, the DOM, or units.
...
// Local date and time for events that can span multiple days.
