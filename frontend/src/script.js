...
// Public API — explicitly exported so the bundler knows what to expose to window.
export { getDefaultTrackColors, resetTrackColorsToDefault, restoreDefaultSettings, decodeNMEA, clearDecoder, toggleInfoPanel, updateTitle, applyDefaultSettings, addTileLayer, removeTileLayer, removeTileLayerAll, addOverlayLayer, removeOverlayLayer, removeOverlayLayerAll, addControlToMap, decimalToDMS, decimalToDDM, copyClipboard, copyToClipboard, openSettings, closeSettings, closeTableSide, setCoordinateFormat, copyCoordinates, decodeHTMLEntities, measureStyleFunction, fetchJSON, createShipOutlineGeometry, showCommunity, showNMEA, showVesselDetail, showBinaryMessageDialog, getBinaryMessageList, copyText, openGoogleSearch, openAIScatcherSite, openMarineTraffic, openShipXplorer, openVesselFinder, openAISHub, openPlaneSpotters, openADSBExchange, openFlightAware, hideMapMenu, showMapMenu, hideContextMenu, showContextMenu, showDialog, closeDialog, showNotification, checkLatestVersion, getStatusVal, getShipTypeVal, headerClick, openWebControl, updateMapLayer, setMap, triggerMapLayer, applyDynamicStyling, setMapOpacity, refreshMeasures, startMeasurementAtPoint, endMeasurement, startMeasureMode, clearMeasureMode, setMeasureMode, initMap, toggleLabel, setMetrics, setTableIcon, getMetrics, addMarker, ToggleFireworks, StartFireworks, StopFireworks, updateMarkerCountTooltip, updateTableSort, updateSortMarkers, compareNumber, compareString, updateTablecard, flashNumber, updateMarkerCount, toggleStatcard, showStatcard, hideStatcard, toggleTablecard, hideTablecard, setRangeSwitch, setRangeColor, setRangeTimePeriod, toggleRange, setFading, toggleFading, setGraphVisibility, toggleGraphVisibility, showPlugins, showServerErrors, fetchAbout, fetchRange, drawRange, removeDistanceCircles, distanceCircleStyleFunction, createDistanceGeometry, updateDistanceCircles, sanitizeString, formatTime, fetchBinary, fetchShips, fetchPlanes, toggleScreenSize, addShipcardItem, hideMenu, showMenu, hideMenuifSmall, toggleMenu, initFullScreen, handleFullScreenChange, calcOffset1M, calcMove, setMapSetting, setTrackClassColor, applyColorToAllTracks, updateTrackColorInputs, average, cssvar, updateChartColors, updateColorMulti, updateColorSingle, updateColorRadar, cloneChartConfig, initPlots, shipcardismax, shipcardselect, toggleShipcardSize, setPulseOk, setPulseError, getCountryName, getFlag, getFlagStyled, fetchStatistics, updateStat, formatBytes, updateStatistics, updateChartMulti, updateChartDistance, updateChartSingle, updateChartLevel, updateRadar, updatePlots, tableRowClick, downloadCSV, searchShips, customShipFilter, updateShipTable, populateShipTableColumnVisibilityMenu, updateShipTableColumnVisibility, resetShipTableColumns, setShipTableColumns, toggleDropdown, getTooltipContent, getTooltipContentPlane, getTypeVal, getShipOpacity, getShipCSSClassAndStyle, getIconCSS, getTableShiptype, getIcon, notImplemented, updateFocusMarker, showHoverTrack, toggleAttribution, getTooltipContentBinary, getBinaryMessageContent, updateHoverMarker, getFeature, debounce, updateMapURL, saveSettings, updateForLegacySettings, loadSettings, convertStringBooleansToActual, loadSettingsFromURL, mapResetViewZoom, mapResetView, shipcardVisible, measurecardVisible, toggleMeasurecard, ToggleTrackOnMap, toggleTrack, showTrack, hideTrack, trackIsShown, pinStation, pinVessel, unpinCenter, showAllTracks, deleteAllTracks, fetchTracks, trackOptionString, updateShipcardTrackOption, isShipcardMax, getStringfromMsgType, getStringfromGroup, getStringfromChannels, setShipcardValidation, updateMessageButton, populateShipcard, updateTechDetails, toggleTechPopover, closeTechPopover, getCategory, populatePlanecard, shipcardMinIfMaxonMobile, drawStation, moveMapCenter, adjustMapForShipcard, pinShipcard, unpinShipcard, applyShipcardPinStyling, toggleShipcardPin, positionAside, displayShipcardIcons, rotateShipcardIcons, prepareShipcard, showShipcard, getSprite, getPlaneSprite, updateMap, redrawBinaryMessages, addMessageToGridCell, createGridCellFeatures, redrawMap, updateAllChartColors, updateDarkMode, setDarkMode, toggleDarkMode, refresh_data, openFocus, updateSettingsTab, toggleRealtimePause, toggleBackgroundStreaming, clearRealtimeTable, promptFilterMMSI, addRealtimeFilterMMSI, removeRealtimeFilterMMSI, updateFilterDisplay, filterRealtimeByMMSI, clearAllRealtimeFilters, clearRealtimeFilter, openRealtimeForMMSI, activateTab, handleRealtimeKeydown, selectMapTab, selectTab, updateAndroid, clearAndHide, restoreOriginalDisplay, setKiosk, setKioskRotationSpeed, setKioskPanMap, updateKioskSpeedDisplay, updateTrackWeightDisplay, updateTrackTrashThresholdDisplay, updateIconScaleDisplay, updateMapOpacityDisplay, updateTooltipFontSizeDisplay, updateShipoutlineOpacityDisplay, updateCircleScaleDisplay, updateKiosk, selectRandomShipForKiosk, showKioskShip, showRandomKioskShip, startKioskAnimation, stopKioskAnimation, toggleKioskMode, showAboutDialog, showWelcome, isAndroid, isKiosk, main, setupAbout, refreshRainviewerLayers, makeDraggable, settings, context_mmsi, card_mmsi, card_type };
