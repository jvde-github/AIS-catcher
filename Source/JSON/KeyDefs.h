...
X(KEY_SETTING_EXCLUDE_QUALITY, "", "", "", "", "exclude_quality", "", "", "Reception marks excluded when FILTER is on: plausible, confirmed, suspect, duplicate, echo, late or none", nullptr)
