...
public:
	...
	const std::vector<AIS::Keys> &getAcceptedKeys() const override
	{
		static const std::vector<AIS::Keys> keys = {
			AIS::KEY_SETTING_PORT, AIS::KEY_SETTING_SERVER_MODE, AIS::KEY_SETTING_ZLIB,
			AIS::KEY_SETTING_GROUPS_IN, AIS::KEY_SETTING_ZONE, AIS::KEY_SETTING_PORT_MIN,
			AIS::KEY_SETTING_PORT_MAX, AIS::KEY_SETTING_STATION, AIS::KEY_SETTING_STATION_LINK,
			AIS::KEY_SETTING_WEBCONTROL_HTTP, AIS::KEY_SETTING_LAT, AIS::KEY_SETTING_LON,
			AIS::KEY_SETTING_CUTOFF, AIS::KEY_SETTING_SHARE_LOC, AIS::KEY_SETTING_IP_BIND,
			AIS::KEY_SETTING_CONTEXT, AIS::KEY_SETTING_MSG, AIS::KEY_SETTING_USE_GPS,
			AIS::KEY_SETTING_KML, AIS::KEY_SETTING_GEOJSON, AIS::KEY_SETTING_OWN_MMSI,
			AIS::KEY_SETTING_HISTORY, AIS::KEY_SETTING_FILE, AIS::KEY_SETTING_CDN,
			AIS::KEY_SETTING_MBTILES, AIS::KEY_SETTING_MBOVERLAY, AIS::KEY_SETTING_FSTILES,
			AIS::KEY_SETTING_FSOVERLAY, AIS::KEY_SETTING_BACKUP, AIS::KEY_SETTING_REALTIME,
			AIS::KEY_SETTING_LOG, AIS::KEY_SETTING_DECODER, AIS::KEY_SETTING_PLUGIN,
			AIS::KEY_SETTING_STYLE, AIS::KEY_SETTING_PLUGIN_DIR, AIS::KEY_SETTING_ABOUT,
			AIS::KEY_SETTING_PROME, AIS::KEY_SETTING_REUSE_PORT,
			// filter keys
			AIS::KEY_SETTING_FILTER, AIS::KEY_SETTING_ALLOW_TYPE, AIS::KEY_SETTING_BLOCK_TYPE,
			AIS::KEY_SETTING_UNIQUE, AIS::KEY_SETTING_POSITION_INTERVAL, AIS::KEY_SETTING_OWN_INTERVAL,
			AIS::KEY_SETTING_REMOVE_EMPTY};
		return keys;
	}
};
